...
var _Months = __webpack_require__(/*! ./Months */ "./client/components/Months.jsx");
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'col-sm-4' },
            ' ',
            _react2.default.createElement('input', { type: 'text', id: 'yearInput', className: 'form-control' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            ...
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'btn btn-primary', onClick: this.changeYear },
              'Searching the year'
            )
          ),
          _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '01' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '02' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '03' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '04' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '05' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '06' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '07' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '08' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '09' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '10' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '11' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-sm-4' },
            _react2.default.createElement(_Months2.default, { indexYear: indexYear, indexMonth: '12' })
          )
        )
      );
    }
...
var Day = function (_React$Component) {
  ...
  function Day(props) {
    ...
    var tmpToday = dd + '/' + mm + '/' + yyyy;

    _this.state = {
      today: tmpToday
    };
    _this.isToday = _this.isToday.bind(_this);
    return _this;
  }
      ...
      return (
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: 'col-md-1' },
            ' ',
            this.isToday(day[5]) ? '★'.concat(String(day[5]).substr(0, 2)) : String(day[5]).substr(0, 2),
            ' '
          ),
          _react2.default.createElement(
            'div',
...
var _Week = __webpack_require__(/*! ./Week */ "./client/components/Week.jsx");
  ...
  _createClass(Month, [{
    ...
    value: function componentDidMount() {
      ...
      var _props = this.props,
          indexYear = _props.indexYear,
          indexMonth = _props.indexMonth;
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.props.indexYear !== prevProps.indexYear) {
        var _props2 = this.props,
            indexYear = _props2.indexYear,
            indexMonth = _props2.indexMonth;
    ...
    value: function renderWeeks() {
      ...
      this.state.monthData.map(function (dates) {
        if (x === 0) {
      ...
      orgDates.map(function (dates) {
        tmpMonth[fstDow + cnt] = dates;
        cnt++;
      });

      return _react2.default.createElement(_Week2.default, { key: tmpMonth,
        date: tmpMonth
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var indexMonth = this.props.indexMonth;
...
var _Day = __webpack_require__(/*! ./Day */ "./client/components/Day.jsx");
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Day2.default, { key: x[0], day: x[0] })
        ),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Day2.default, { key: x[1], day: x[1] })
        ),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Day2.default, { key: x[2], day: x[2] })
        ),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Day2.default, { key: x[3], day: x[3] })
        ),
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Day2.default, { key: x[4], day: x[4] })
        )
      );
    }
  }]);
